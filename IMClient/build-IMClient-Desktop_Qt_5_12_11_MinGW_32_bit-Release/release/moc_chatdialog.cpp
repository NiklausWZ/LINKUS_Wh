...
QT_MOC_LITERAL(5, 43, 18) // "on_pb_send_clicked"

    },
    "ChatDialog\0sig_sendChatMessage\0\0content\0"
...
void ChatDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_sendChatMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatDialog::sig_sendChatMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatDialog::sig_sendChatMessage(QString _t1, int _t2)
{
